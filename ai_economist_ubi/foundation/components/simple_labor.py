...
class SimpleLabor(BaseComponent):
    ...
    def component_step(self):
        ...
        for agent in self.world.get_random_order_agents():
            ...
            if 0 < action <= int(self.num_labor_hours//self.labor_step):
                ...
                print(action)
                print(self.num_labor_hours)
                print(self.labor_step)
                print(int(self.num_labor_hours//self.labor_step))
                if action > int(self.num_labor_hours//self.labor_step):
                    print(f'{action}>{int(self.num_labor_hours//self.labor_step)}')
