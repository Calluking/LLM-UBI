...
from ai_economist_ubi.foundation.agents import agent_registry
from ai_economist_ubi.foundation.base.registrar import Registry
from ai_economist_ubi.foundation.base.world import World
from ai_economist_ubi.foundation.components import component_registry
from ai_economist_ubi.foundation.entities import (
    endogenous_registry,
    landmark_registry,
    resource_registry,
)
...
class BaseEnvironment(ABC):
    ...
    Example:
        from ai_economist_ubi import foundation
    ...
    Example:
        from ai_economist_ubi import foundation
        from ai_economist_ubi.foundation.base.base_env import BaseEnvironment
...
Example:
    from ai_economist_ubi.foundation.base.base_env
